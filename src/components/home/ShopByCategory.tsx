...
const CATEGORY_CARDS = [
  {
    name: 'Backpacks',
    slug: 'backpacks',
    image: '/products/koool-backpack-angle.jpg',
  ...
  },
  {
    name: 'Lunch Boxes',
    slug: 'lunch-boxes',
    image: '/products/bento-5-compartment-tabletop.png',
  ...
  },
  {
    name: 'Water Bottles',
    slug: 'water-bottles',
    image: '/products/tedemei-soup-mug-hero.png',
...
export function ShopByCategory() {
  return (
    <section className="w-full max-w-full overflow-hidden py-16 sm:py-24 bg-brand-cream-50 dark:bg-zinc-950 border-b border-brand-cream-300 dark:border-zinc-800">
