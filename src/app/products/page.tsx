  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="mb-8 space-y-2 text-left">
        ...
        <h1 className="font-serif font-extrabold text-3xl sm:text-4xl text-brand-forest-950 uppercase tracking-tight">
          All Products
        </h1>
      ...
      <Suspense
        fallback={
          <div className="py-20 text-center">
            <div className="w-10 h-10 border-4 border-brand-forest-800 border-t-transparent rounded-full animate-spin mx-auto mb-4" />
            <p className="text-xs font-semibold text-brand-charcoal-600">Loading catalog...</p>
          </div>
        }
      >
