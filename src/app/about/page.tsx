  ...
  return (
    <div className="py-12 sm:py-16">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-4 mb-16">
        ...
        <h1 className="font-serif font-extrabold text-3xl sm:text-5xl text-brand-forest-950 dark:text-white tracking-tight leading-tight">
          Thoughtful objects for your daily rhythm.
        </h1>
        <p className="text-base sm:text-lg text-brand-charcoal-600 dark:text-zinc-300 leading-relaxed max-w-2xl mx-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <h2 className="font-serif font-bold text-2xl sm:text-3xl text-brand-forest-950 dark:text-white">
              Why We Started
            </h2>
            <p className="text-sm sm:text-base text-brand-charcoal-700 dark:text-zinc-300 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <div className="p-4 rounded-2xl bg-brand-cream-100 dark:bg-zinc-900 border border-brand-cream-300 dark:border-zinc-800">
                <div className="font-serif font-bold text-2xl text-brand-forest-900 dark:text-emerald-400">100%</div>
                <div className="text-xs text-brand-charcoal-600 dark:text-zinc-400 mt-1">SUS304 Food-Grade Stainless Steel</div>
              </div>
              <div className="p-4 rounded-2xl bg-brand-cream-100 dark:bg-zinc-900 border border-brand-cream-300 dark:border-zinc-800">
                <div className="font-serif font-bold text-2xl text-brand-forest-900 dark:text-emerald-400">0%</div>
                <div className="text-xs text-brand-charcoal-600 dark:text-zinc-400 mt-1">BPA, Phthalates & Toxic Coatings</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Material Pillars */}
      <div className="bg-brand-forest-900 dark:bg-zinc-900 text-white py-16 border-y dark:border-zinc-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <h3 className="font-serif font-bold text-3xl text-white">
              Material Standards Without Compromise
            </h3>
            <p className="text-xs sm:text-sm text-brand-cream-200 dark:text-zinc-300 mt-2">
              Every detail is engineered for health, ergonomics, and longevity.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-brand-forest-950 dark:bg-zinc-950 p-6 rounded-3xl border border-brand-forest-800 dark:border-zinc-800 space-y-3">
              ...
              <p className="text-xs text-brand-cream-300 dark:text-zinc-400 leading-relaxed">
      ...
      <div className="max-w-4xl mx-auto px-4 text-center py-16 space-y-4">
        <h3 className="font-serif font-bold text-2xl sm:text-3xl text-brand-forest-950 dark:text-white">
