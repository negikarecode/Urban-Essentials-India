  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <nav className="flex items-center gap-2 text-xs font-semibold text-brand-charcoal-500 mb-6">
        ...
        <span className="text-brand-forest-900">Wishlist</span>
      </nav>

      <h1 className="font-serif font-extrabold text-3xl text-brand-forest-950 mb-8">
        ...
        {wishlistProducts.map((product) => (
          ...
          >
            <div>
              ...
              <div className="p-4">
                <span className="text-[10px] font-bold text-brand-forest-800 uppercase tracking-wider">
                  {product.category_name}
                </span>
                <h3 className="font-serif font-bold text-sm text-brand-charcoal-900 line-clamp-1 mt-0.5 hover:text-brand-forest-800">
                  <Link href={`/products/${product.slug}`}>
                    {product.name}
                  </Link>
                </h3>
                <div className="text-xs font-extrabold text-brand-forest-950 mt-1">
