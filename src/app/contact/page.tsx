    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-white rounded-3xl p-6 border border-brand-cream-300 shadow-xs space-y-5">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 rounded-xl bg-brand-forest-100 text-brand-forest-800 flex items-center justify-center shrink-0">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="font-bold text-sm text-brand-charcoal-900">WhatsApp & Phone Support</h4>
                <p className="text-xs text-brand-charcoal-500 mt-0.5">Mon - Sat: 9:00 AM - 7:00 PM IST</p>
                <span className="text-xs font-bold text-brand-forest-800 mt-1 block">
                  +91 98765 43210
                </span>
              </div>
            </div>
          ...
          <div className="bg-brand-forest-900 text-white rounded-3xl p-6 border border-brand-forest-800 space-y-2">
            ...
            <p className="text-xs text-brand-cream-200 leading-relaxed">
        ...
        {/* Contact Form */}
        <div className="lg:col-span-7 bg-white rounded-3xl p-6 sm:p-8 border border-brand-cream-300 shadow-xs">
          <h3 className="font-serif font-bold text-xl text-brand-forest-950 mb-6 pb-3 border-b border-brand-cream-200">
            Send us a Message
          </h3>
